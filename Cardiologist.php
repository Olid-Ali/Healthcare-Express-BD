...
<div class="container mt-5">
    <div class="row">
        ...
        $query = "SELECT * FROM doctor WHERE category = 'Cardiologist'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img class="card-img-top mx-auto" src="img/random2.jpg" style="width: 180px; height: 21vh;" alt="Card image cap">
                        <div class="card-body">
